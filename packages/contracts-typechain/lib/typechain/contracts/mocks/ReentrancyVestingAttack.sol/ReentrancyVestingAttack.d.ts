...
export interface ReentrancyVestingAttackInterface extends Interface {
...
export interface ReentrancyVestingAttack extends BaseContract {
    connect(runner?: ContractRunner | null): ReentrancyVestingAttack;
    waitForDeployment(): Promise<this>;
    interface: ReentrancyVestingAttackInterface;
