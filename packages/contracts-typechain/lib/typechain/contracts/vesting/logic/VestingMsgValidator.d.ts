...
export interface VestingMsgValidatorInterface extends Interface {
...
export interface VestingMsgValidator extends BaseContract {
    connect(runner?: ContractRunner | null): VestingMsgValidator;
    waitForDeployment(): Promise<this>;
    interface: VestingMsgValidatorInterface;
