...
export interface AnteHandlerInterface extends Interface {
}
export interface AnteHandler extends BaseContract {
    connect(runner?: ContractRunner | null): AnteHandler;
    waitForDeployment(): Promise<this>;
    interface: AnteHandlerInterface;
