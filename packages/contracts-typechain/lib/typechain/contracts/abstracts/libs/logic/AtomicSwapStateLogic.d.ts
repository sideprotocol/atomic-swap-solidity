...
export interface AtomicSwapStateLogicInterface extends Interface {
...
export interface AtomicSwapStateLogic extends BaseContract {
    connect(runner?: ContractRunner | null): AtomicSwapStateLogic;
    waitForDeployment(): Promise<this>;
    interface: AtomicSwapStateLogicInterface;
