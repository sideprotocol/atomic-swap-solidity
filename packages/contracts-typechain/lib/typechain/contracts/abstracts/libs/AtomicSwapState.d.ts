...
export interface AtomicSwapStateInterface extends Interface {
...
export interface AtomicSwapState extends BaseContract {
    connect(runner?: ContractRunner | null): AtomicSwapState;
    waitForDeployment(): Promise<this>;
    interface: AtomicSwapStateInterface;
