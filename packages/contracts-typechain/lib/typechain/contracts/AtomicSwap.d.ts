...
export declare namespace IAtomicSwap {
    ...
    type CounterOfferMsgStructOutput = [string, string, BigNumber] & {
        orderID: string;
        bidder: string;
        amount: BigNumber;
    };
...
export interface AtomicSwapInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptBid" | "acceptCountOfffer" | "bids" | "buyerFeeRate" | "cancelBid" | "cancelSwap" | "counteroffer" | "counteroffers" | "initialize" | "makeSwap" | "owner" | "placeBid" | "renounceOwnership" | "sellerFeeRate" | "swapOrder" | "takeSwap" | "transferOwnership" | "updateBid"): FunctionFragment;
    encodeFunctionData(functionFragment: "acceptBid", values: [IAtomicSwap.AcceptBidMsgStruct]): string;
    encodeFunctionData(functionFragment: "acceptCountOfffer", values: [IAtomicSwap.CounterOfferMsgStruct]): string;
    ...
    encodeFunctionData(functionFragment: "counteroffer", values: [IAtomicSwap.CounterOfferMsgStruct]): string;
    encodeFunctionData(functionFragment: "counteroffers", values: [PromiseOrValue<BytesLike>, PromiseOrValue<string>]): string;
...
export interface AtomicSwap extends BaseContract {
    ...
    functions: {
        ...
        acceptCountOfffer(counterOfferMsg: IAtomicSwap.CounterOfferMsgStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        counteroffer(counterOfferMsg: IAtomicSwap.CounterOfferMsgStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        counteroffers(arg0: PromiseOrValue<BytesLike>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        acceptCountOfffer(counterOfferMsg: IAtomicSwap.CounterOfferMsgStruct, overrides?: CallOverrides): Promise<void>;
        bids(arg0: PromiseOrValue<BytesLike>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[
            BigNumber,
            string,
            number,
        ...
        counteroffer(counterOfferMsg: IAtomicSwap.CounterOfferMsgStruct, overrides?: CallOverrides): Promise<void>;
        counteroffers(arg0: PromiseOrValue<BytesLike>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        counteroffers(arg0: PromiseOrValue<BytesLike>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(_admin: PromiseOrValue<string>, _treasury: PromiseOrValue<string>, _sellerFee: PromiseOrValue<BigNumberish>, _buyerFee: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        makeSwap(makeswap: IAtomicSwap.MakeSwapMsgStruct, overrides?: PayableOverrides & {
