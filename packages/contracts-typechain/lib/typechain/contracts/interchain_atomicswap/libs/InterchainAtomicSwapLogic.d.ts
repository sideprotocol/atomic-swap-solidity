...
export interface InterchainAtomicSwapLogicInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "_validateInitializeParams", values: [IInterchainAtomicSwap.InitialParamsStruct, BigNumberish]): string;
    decodeFunctionResult(functionFragment: "_validateInitializeParams", data: BytesLike): Result;
}
