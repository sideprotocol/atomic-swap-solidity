...
export interface ILayerZeroUserApplicationConfigUpgradeableInterface extends Interface {
    getFunction(nameOrSignature: "forceResumeReceive" | "setConfig" | "setReceiveVersion" | "setSendVersion"): FunctionFragment;
...
export interface ILayerZeroUserApplicationConfigUpgradeable extends BaseContract {
    connect(runner?: ContractRunner | null): ILayerZeroUserApplicationConfigUpgradeable;
