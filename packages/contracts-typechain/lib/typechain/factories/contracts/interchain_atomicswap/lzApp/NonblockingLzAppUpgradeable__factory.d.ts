...
import type { NonblockingLzAppUpgradeable, NonblockingLzAppUpgradeableInterface } from "../../../../contracts/interchain_atomicswap/lzApp/NonblockingLzAppUpgradeable";
export declare class NonblockingLzAppUpgradeable__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): NonblockingLzAppUpgradeable;
}
