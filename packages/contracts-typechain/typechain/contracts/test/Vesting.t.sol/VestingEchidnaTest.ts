...
export interface VestingEchidnaTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
      ...
      | "approve"
      | "balanceOf"
      | "echidna_test_no_release_before_start"
      | "echidna_test_released_never_exceeds_vested"
      | "fuzz_release"
      | "fuzz_startVesting"
      | "getApproved"
      | "getRoleAdmin"
  ...
  encodeFunctionData(
    functionFragment: "echidna_test_no_release_before_start",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "echidna_test_released_never_exceeds_vested",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "fuzz_release",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "fuzz_startVesting",
    values: [
      BytesLike,
      AddressLike,
      AddressLike,
...
export interface VestingEchidnaTest extends BaseContract {
  connect(runner?: ContractRunner | null): VestingEchidnaTest;
  waitForDeployment(): Promise<this>;

  interface: VestingEchidnaTestInterface;
  ...
  echidna_test_no_release_before_start: TypedContractMethod<
    [],
    [boolean],
    "view"
  >;

  echidna_test_released_never_exceeds_vested: TypedContractMethod<
    [],
    [boolean],
    "view"
  >;

  fuzz_release: TypedContractMethod<
    [vestingId: BigNumberish],
    [void],
    "nonpayable"
  >;

  fuzz_startVesting: TypedContractMethod<
    [
      orderId: BytesLike,
      buyer: AddressLike,
      token: AddressLike,
  ...
  getFunction(
    nameOrSignature: "echidna_test_no_release_before_start"
  ): TypedContractMethod<[], [boolean], "view">;
  getFunction(
    nameOrSignature: "echidna_test_released_never_exceeds_vested"
  ): TypedContractMethod<[], [boolean], "view">;
  getFunction(
    nameOrSignature: "fuzz_release"
  ): TypedContractMethod<[vestingId: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "fuzz_startVesting"
  ): TypedContractMethod<
    [
      orderId: BytesLike,
      buyer: AddressLike,
