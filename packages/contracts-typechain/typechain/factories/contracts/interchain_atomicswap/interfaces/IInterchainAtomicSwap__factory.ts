...
import type {
  IInterchainAtomicSwap,
  IInterchainAtomicSwapInterface,
} from "../../../../contracts/interchain_atomicswap/interfaces/IInterchainAtomicSwap";
...
export class IInterchainAtomicSwap__factory {
  static readonly abi = _abi;
  static createInterface(): IInterchainAtomicSwapInterface {
    return new Interface(_abi) as IInterchainAtomicSwapInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IInterchainAtomicSwap;
  }
}
